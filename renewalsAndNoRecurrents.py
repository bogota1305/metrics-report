...
def get_sales(start_date, end_date, folder_name):
    
    file_name = 'Sales'
    resumeData = process_data(start_date, end_date)
    ...
    save_dataframe_to_excel(folder_name, file_name, resumeData, 'General', columns_to_plot, colors, grafico_positions, False, None, None, None, None, None, None, None, None, None, None, None, None)