...
def process_data(start_date, end_date):
    ...
    print(f"Cantidad de grupos con errores de pago después del start_date: {error_group_count}")
    ...
    return daily_summary, error_reasons

def get_payments(start_date, end_date, folder_name):
    
    file_name = 'Payment Errors'
    daily_summary, error_reasons = process_data(start_date, end_date)
    ...
    save_dataframe_to_excel(folder_name, file_name, daily_summary, 'General', columns_to_plot, colors, grafico_positions, False, None, None, None, None, None, None, None, None, None, None, None, None)

    # Guardar razones de error en Excel con Pandas
    save_error_reasons_with_chart(folder_name, file_name, error_reasons, True)
