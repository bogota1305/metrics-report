...
from selectFiles import nombre_archivo, seleccionar_archivos

data = seleccionar_archivos()
nombre_salida = ''
while nombre_salida == '':
...
save_dataframe_to_excel_ga4(percentages_table, percentages_previous_step, final_table_spaced_with_previous, nombre_salida)
